...
class Idioma(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text='Escribir idioma.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='idioma_usuario_editor')
