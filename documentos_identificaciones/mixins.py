...
class AccessUserRequiredMixin(LoginRequiredMixin, MultiplePermissionsRequiredMixin):
	...
	permissions   = {
		'all':( 'documentos_identificaciones.add_documento_identificacion', 
				'documentos_identificaciones.change_documento_identificacion', 
				'documentos_identificaciones.delete_documento_identificacion'),
	}
