...
class Respuesta(models.Model):
	#Atributos
	respuesta   					= models.CharField(max_length=255, unique=True, help_text='Escribir respuesta.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='respuesta_usuario_editor')
	...
	def save(self, *args, **kwargs):
		if not self.pk:
			self.slug = slugify(self.respuesta)
