...
class ExperienciaDocente(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text='Escribir experiencia como docentes.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='experienciasdocente_usuario_editor')
	...
	def save(self, *args, **kwargs):
		...
		super(ExperienciaDocente, self).save(*args, **kwargs)
	...
	class Meta:
		...
		db_table = 'Experiencias_Docentes'
		#Ordenar los registros por un campo especifico
		ordering = ('nombre',)
		#Nombre para el Conjunto de Objetos en el Panel de Administración
		verbose_name = 'Experiencia Docente' 
		#Nombre en Plural en la lista de módulos en el Panel de Administración
		verbose_name_plural = 'Experiencias Docentes'