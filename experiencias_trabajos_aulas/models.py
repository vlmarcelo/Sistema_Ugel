...
class ExperienciaTrabajoAula(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text='Escribir experiencia trabajo aula.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='experienciatrabajoaula_usuario_editor')
	...
	def save(self, *args, **kwargs):
		...
		super(ExperienciaTrabajoAula, self).save(*args, **kwargs)
