    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_postal', models.PositiveIntegerField(help_text='Escribir c\xf3digo postal del departamento.', unique=True, verbose_name='C\xf3digo postal')),
                ('imagen', models.ImageField(blank=True, default='default/No-Image-1.png', help_text='Subir imagen del departamento. (Opcional)', upload_to='imagenes_departamentos')),
