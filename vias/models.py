...
class Via(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, db_index=True, help_text='Escribir vía.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='via_usuario_editor')
