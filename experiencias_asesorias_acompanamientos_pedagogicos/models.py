...
class ExperienciaAsesoriaAcompanamiento(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text='Escribir experiencia asesoria acompañamiento')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='experimientoasesoriaacompanamiento_usuario_editor')
	...
	def save(self, *args, **kwargs):
		...
		super(ExperienciaAsesoriaAcompanamiento, self).save(*args, **kwargs)
