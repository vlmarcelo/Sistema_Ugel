...
class GradoInstruccion(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text='Escribir vía.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='gradoinstruccion_usuario_editor')
	...
	def save(self, *args, **kwargs):
		...
		super(GradoInstruccion, self).save(*args, **kwargs)
	#Métodos
