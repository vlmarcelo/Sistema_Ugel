...
class ExperienciaSectorPublico(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text='Escribir experiencia sector publico.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='experienciasectorpublico_usuario_editor')
	...
	def save(self, *args, **kwargs):
		...
		super(ExperienciaSectorPublico, self).save(*args, **kwargs)
