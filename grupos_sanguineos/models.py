...
class GrupoSanguineo(models.Model):
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='gruposanguineo_usuario_editor')
	...
	def save(self, *args, **kwargs):
		...
		super(GrupoSanguineo, self).save(*args, **kwargs)
	#Métodos
