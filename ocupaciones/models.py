...
class Ocupacion(models.Model):
	nombre 							= models.CharField(max_length=255, unique=True, help_text='Escribir Cargo.')
	...
	ultimo_usuario_editor			= models.ForeignKey(Usuario, related_name='ocupacion_usuario_editor')
	...
	def save(self, *args, **kwargs):
		...
		super(Ocupacion, self).save(*args, **kwargs)
	#Métodos
